...
const DrinkBooking = () => {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("drinkBooking", JSON.stringify(bookingDetails));
    navigate("/drinkReceipt");
  };

  if (!drink) {
    return (
      <div className="w-full h-screen flex items-center justify-center flex-col bg-gradient-to-br from-gray-100 via-blue-50 to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 text-center mt-2 px-4 md:w-[60%]">
          {t("Please select a drink before placing an order.")}
        </p>
  ...
  return (
    <>
      <div className="min-h-screen bg-linear-to-br from-gray-100 via-blue-50 to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 px-4 pt-24 pb-8">
        ...
        <div className="w-full mx-auto grid md:grid-cols-2 gap-5">
          ...
          <form
            ...
            className="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 space-y-4 border border-gray-100 dark:border-gray-800"
          >

            <h2 className="text-xl font-bold text-blue-600 mb-2">
              {t("Drink Order Details")}
            </h2>
