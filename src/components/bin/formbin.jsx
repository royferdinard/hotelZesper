...
const BookingForm = () => {
  ...
  return (
    <section className="relative -mt-16 max-w-full mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-white shadow-sm rounded-lg border border-slate-200 overflow-hidden">

        {/* Tabs */}
        <div className="bg-slate-50 border-b border-slate-200 p-4">
          <div className="relative z-20 flex flex-wrap rounded-xl bg-slate-200 p-2 gap-2 w-fit">
            {bookingSections.map((section) => (
              <button
                key={section.id}
                type="button"
                onClick={() => setActiveSection(section.id)}
                className={`px-5 py-2.5 text-sm font-semibold rounded-full text-sm transition-all ${
                  ...
                  return (
                    <label key={field.name} className="space-y-2 sm:col-span-2 text-sm lg:col-span-5 ">
                      ...
                      <textarea
                        ...
                        className="w-full min-w-0 rounded-md mt-2 text-xs text-gray-500 outline-none focus:ring focus:ring-blue-600 transition-all duration-300 border-2 border-slate-200 px-4 py-5 resize-none"
                      />
                  ...
                  return (
                    <label key={field.name} className="space-y-2 w-full flex flex-col">
                      ...
                      <select
                        ...
                        value={formData[field.name]}
                        onChange={handleChange}
                        className="w-full min-w-0 rounded-md text-xs mt-2 text-gray-500 outline-none focus:ring focus:ring-blue-600 transition-all duration-300 border-2 border-slate-200 px-3 py-3"
                      >
                ...
                return (
                  <label key={field.name} className="space-y-2 w-full flex flex-col">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder={t(field.placeholder)}
                      className="w-full rounded-md min-w-0 outline-none text-gray-500 mt-2 text-xs focus:ring focus:ring-blue-600 transition-all duration-300 border-2 border-slate-200 px-3 py-3"
                    />
